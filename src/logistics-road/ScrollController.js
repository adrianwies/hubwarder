...
export class ScrollController {
  ...
  init(){
    this.visibilityTrigger=ScrollTrigger.create({trigger:this.section,start:'top top',end:'bottom bottom',onEnter:()=>this.scene.setSectionActive(true),onEnterBack:()=>this.scene.setSectionActive(true),onLeave:()=>this.scene.setSectionActive(false),onLeaveBack:()=>this.scene.setSectionActive(false)});

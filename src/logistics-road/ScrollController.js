...
export class ScrollController {
  ...
  init(){
    ...
    this.trigger=ScrollTrigger.create({trigger:this.section,start:'top bottom',end:'bottom bottom',invalidateOnRefresh:true,onUpdate:self=>{this.state.progress=self.progress;this.scene.setProgress(self.progress);}});
